  ...
  return (
    <section className="relative w-full h-screen mx-auto bg-hero-pattern bg-cover bg-center bg-no-repeat">
      ...
      `,
          ...
          >
            A seasoned QA Engineer with around 4 years of expertise in 
            <br className="sm:block hidden" />
            QA Automation and Application Support, dedicated to 
            <br className="sm:block hidden" />
            software quality assurance and testing with innovative solutions.
          </p>
        </div>
      </div>
