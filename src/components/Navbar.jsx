...
import { logoanik, menu, close } from "../../public/assets";
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          />
          <p className="text-white text-[20px] font-extrabold cursor-pointer flex flex-col transition-all duration-300">
            <span className="text-white text-[20px] font-bold m-0">Shaharehar Rahaman Anik</span>
            <span className="text-white text-[14px] font-normal m-0 mt-1">Software Quality Assurance (SQA) Engineer</span>
          </p>
        </Link>
